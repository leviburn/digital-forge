...
var count = (0, vue_1.ref)(0); /* PartiallyEnd: #3632/scriptSetup.vue */
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)(__assign({ class: ("read-the-docs") }));
    ['card', 'read-the-docs',];
    var __VLS_slots;
    var $slots;
